...
public class GetSearchIdService {
    static GetSearchIdService getInstance(){
        return instance;
    }
    ...
    private final static GetSearchIdService instance;
    static {
        instance = new GetSearchIdService();
    }
    ...
    public int getSearchId(String searchText, TimetableOwner owner){
        ...
        throw new RuntimeException("switch expsression error");
    }
    ...
    private SearchProduct[] getSearchProductArrayFromUrl(String url, String searchString) throws IOException{
        return jsonConverter.readValue(
                new URL(String.format(url, URLEncoder.encode(searchString, "UTF-8"))),
                SearchProduct[].class
        );
    }
